...
**[Windows](https://github.com/oscarfIt/World-in-Windows/releases/latest/download/WorldInWindows.exe)**  
**[Mac](https://github.com/oscarfIt/World-in-Windows/releases/latest/download/WorldInWindows)**  
Linux see my detailed instructions below for building from source.
